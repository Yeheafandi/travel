...
class TelegramApiService {
  Future<Map<String, dynamic>> getUpdates({
    ...
    final url = Uri.parse(
      '${TelegramConfig.baseUrl}/getUpdates',
    ).replace(queryParameters: queryParameters);

    final response = await http.get(url);

    if (response.statusCode != 200) {
      throw Exception('Failed to call getUpdates: ${response.statusCode}');
    }
  ...
  Future<Map<String, dynamic>> setMyCommands() async {
    final url = Uri.parse('${TelegramConfig.baseUrl}/setMyCommands');
    ...
    if (response.statusCode != 200) {
      throw Exception('Failed to call setMyCommands: ${response.statusCode}');
    }
  ...
  Future<Map<String, dynamic>> sendMessage({
    ...
    final url = Uri.parse('${TelegramConfig.baseUrl}/sendMessage');
    ...
    if (response.statusCode != 200) {
      throw Exception('Failed to call sendMessage: ${response.statusCode}');
    }
  ...
  Future<Map<String, dynamic>> answerCallbackQuery({
    ...
    final url = Uri.parse('${TelegramConfig.baseUrl}/answerCallbackQuery');
    ...
    if (response.statusCode != 200) {
      throw Exception(
        'Failed to call answerCallbackQuery: ${response.statusCode}',
      );
    }
  ...
  Future<Map<String, dynamic>> editMessageText({
    ...
    final url = Uri.parse('${TelegramConfig.baseUrl}/editMessageText');
    ...
    if (response.statusCode != 200) {
      throw Exception('Failed to call editMessageText: ${response.statusCode}');
    }
